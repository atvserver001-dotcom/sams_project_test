...
const directory = path.join(root, 'tests', 'admin-preview')
const port = Number(process.argv[2] || 18476)
...
// Refresh only the approved logo; do not copy environment or school data files.
